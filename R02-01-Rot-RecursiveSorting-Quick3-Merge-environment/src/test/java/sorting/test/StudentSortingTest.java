...
public class StudentSortingTest {
	...
	public void setUp() {
		...
		populaMeuVetor(new Integer[] { 4, 2, 5, 1, 3 ,7});
	...
	public void populaMeuVetor(Integer[] arrayPadrao) {
		this.meuVetor = Arrays.copyOf(arrayPadrao, arrayPadrao.length);
	}
